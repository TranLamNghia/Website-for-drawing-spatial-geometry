...
public static class PointIntegrityHelper
{
    ...
    public static List<string> FilterSegments(EntitiesDto entities, IEnumerable<string> segments)
    {
        ...
        foreach (var solid in entities.Solids)
        {
            ...
            {
                // Pyramid S.ABCD: lateral edges + all base edges
                var apex = face1[0];
            ...
            {
                // Prism / box ABCD.A'B'C'D': bottom base, top base, lateral edges
    ...
    /// <summary>Internal auxiliary point generated by a handler (e.g. _P_1 for a tangent plane).</summary>
